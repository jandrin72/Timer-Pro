...
const TRANSLATIONS = {
  es: {
    ...
    share: "Compartir",
    delete: "Eliminar",
    how_did_it_feel: "¿Cómo te sentiste? (notas, sensaciones, etc.)",
    ...
    notes_placeholder: "ej. Me sentí fuerte, buena forma durante todo el entrenamiento...",
    ...
    notes_placeholder_tabata: "ej. Ritmo intenso pero controlado, buena forma durante todo el entrenamiento...",
    ...
    notes_placeholder_fortime: "ej. Tiempo récord, mejorar transiciones...",
    ...
    notes_placeholder_amrap: "ej. Ritmo constante, mejorar transiciones...",
  ...
  en: {
    ...
    share: "Share",
    delete: "Delete",
    how_did_it_feel: "How did it feel? (notes, reflections, etc.)",
    ...
    notes_placeholder: "e.g., felt strong, good form throughout...",
    ...
    notes_placeholder_tabata: "e.g., intense but controlled pace, solid form throughout...",
    ...
    notes_placeholder_fortime: "e.g. record time, improve transitions...",
    ...
    notes_placeholder_amrap: "e.g. consistent pace, improve transitions...",
  ...
  de: {
    ...
    share: "Teilen",
    delete: "Löschen",
    how_did_it_feel: "Wie hat es sich angefühlt? (Notizen, Eindrücke, etc.)",
    emom_app_title: "EMOM Timer Pro",
    ...
    notes_placeholder: "z.B. Fühlte mich stark, saubere Technik während des gesamten Trainings...",
    ...
    notes_placeholder_tabata: "z.B. Intensives aber kontrolliertes Tempo, gute Form durchgehend...",
    ...
    notes_placeholder_fortime: "z.B. Rekordzeit, Übergänge verbessern...",
    ...
    notes_placeholder_amrap: "z.B. Konstantes Tempo, Übergänge verbessern...",
  ...
  fr: {
    ...
    share: "Partager",
    delete: "Supprimer",
    how_did_it_feel: "Comment vous êtes-vous senti ? (notes, sensations, etc.)",
    ...
    notes_placeholder: "ex. Je me suis senti fort, bonne technique tout au long...",
    ...
    notes_placeholder_tabata: "ex. Rythme intense mais contrôlé, bonne forme tout au long...",
    ...
    notes_placeholder_fortime: "ex. Temps record, améliorer les transitions...",
    ...
    notes_placeholder_amrap: "ex. Rythme constant, améliorer les transitions...",
  ...
  it: {
    ...
    "share": "Condividi",
    "delete": "Elimina",
    "how_did_it_feel": "Come ti sei sentito? (note, sensazioni, ecc.)",
    ...
    "notes_placeholder": "es. Mi sono sentito forte, buona tecnica per tutto l'allenamento...",
    ...
    "notes_placeholder_tabata": "es. Ritmo intenso ma controllato, buona forma per tutto...",
    ...
    "notes_placeholder_fortime": "es. Tempo record, migliorare le transizioni...",
    ...
    "notes_placeholder_amrap": "es. Ritmo costante, migliorare le transizioni...",
  ...
  pt: {
    ...
    "share": "Compartilhar",
    "delete": "Deletar",
    "how_did_it_feel": "Como você se sentiu? (notas, sensações, etc.)",
    "emom_app_title": "Cronómetro EMOM Pro",
    "seconds_per_cycle": "Segundos por ciclo:",
    ...
    "notes_placeholder": "ex. Me senti forte, boa técnica durante todo o treino...",
    ...
    "notes_placeholder_tabata": "ex. Ritmo intenso porém controlado, boa forma o treino todo...",
    ...
    "notes_placeholder_fortime": "ex. Tempo recorde, melhorar transições...",
    ...
    "notes_placeholder_amrap": "ex. Ritmo consistente, melhorar transições...",
  ...
  zh: {
    ...
    "optional": "可选",
    "workout_notes": "训练备注",
    "notes_placeholder": "例如：感觉很强壮，全程动作标准...",
    ...
    "notes_placeholder_tabata": "例如：节奏强烈但可控，全程动作标准...",
    ...
    "notes_placeholder_fortime": "例如：刷新纪录，改进转换...",
    ...
    "notes_placeholder_amrap": "例如：节奏稳定，改进转换...",
